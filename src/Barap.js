...
import {Tooltip,Drawer,Divider,Chip,List,Button,ListItem,ListItemIcon,CssBaseline,ListItemText,Avatar,Backdrop, Paper } from '@material-ui/core'
...
function Barap(props) {
  ...
  return (
    ...
    <div className={classes.grow}>
     ...
     {!fileapp&&<div className={classes.grow}>
      <CssBaseline />
      <div className={clsx(classes.appBar, {
          [classes.appBarShift]: open,
          [classes.appBarShiftclose]: !open,
    ...
    <ThemeProvider theme={drawtheme} >
      <AppBar color="primary" position="static" className={classes.fab}>
        ...
        <div /*className={classes.sectionMobile}*/><IconButton
          ...
          [classes.sectionDesktopclose]: !open,
            ...
            <Tooltip title="Theme Changer"><IconButton onClick={props.fun}>{props.dar?<Brightness5 />:<Brightness2 />}</IconButton></Tooltip>
            <Tooltip title="Log Out"><IconButton onClick={() => setFileapp(!fileapp)}><PowerSettingsNew /></IconButton></Tooltip>
            <Tooltip title="Notification">
            <IconButton aria-label="show 17 new notifications" color="inherit">
              <Badge badgeContent={17} color="secondary">
                <NotificationsIcon />
      ...
      >
       <div className={classes.drawerHeader} />
        {/*<Butto />*/}
        <div /*className={classes.bishal}*/>{mainitem2}
          {/*<Menu
              id="fade-menu"
              //anchorEl={anchorEl}
               //keepMounted
               className={classes.bodmen}
               open={profilele}
               onClose={()=>setProfilele(false)}
               //TransitionComponent={Fade}
             >
          <Tabmen />
             </Menu>*/}
             {/*profilele&&<div>
             <Tabmen className={classes.bodmen} />
             </div>*/}
             <Backdrop className={classes.backdrop} open={profilele} >
              <div className={classes.bodmen} ><Tabmen funct={setProfilele} funk={profilele} /></div>
           </Backdrop>
